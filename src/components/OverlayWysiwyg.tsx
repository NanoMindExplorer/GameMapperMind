 ...
 *      callers receive absolute screen coordinates (not local-to-drawable).
 *
...
function percentToAbsolutePixels(xPct: number, yPct: number): { x: number; y: number } {
  ...
  // This ensures touch injection targets the correct pixel even when the
  // drawable area is offset by notch/cutout safe-area insets.
  return {
 ...
 * before dividing to undo the origin offset applied during forward
 * conversion.
 *
